...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal() {
        ...
        A.getPartidas().add(new Partida("Grieta del Invocador"));
        P.getJugadores().add(new Jugador("James", 100));
        P.getJugadores().add(new Jugador("Juan", 110));
        P.getEstrellas().add(new Estrella(600, "Moneda de gran valor para los fiferos", "Fifa Point"));
        P.getEstrellas().add(new Estrella(600, "Moneda dorada de gran valor", "Moneda de oro"));
        A.escribirArchivo();
    }

    AdminPartida A=new AdminPartida("./");
